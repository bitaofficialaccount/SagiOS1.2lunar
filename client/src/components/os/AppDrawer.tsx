import { Globe, FileText, Calculator, Settings, FolderOpen, X, Image, Cloud, Video, Music, Mail, Map, Newspaper, BookOpen, Compass, Zap, SquareCheckBig } from "lucide-react";
